...
namespace CybageConnect.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(UserDTO userDTO)
        {
            try
            {
                ValidateDTO validationResult = await _authService.ValidateFields(userDTO.Username, userDTO.Email, userDTO.Phone);
        ...
        public async Task<IActionResult> Login(LoginDTO loginDTO)
        {
            try
            {
                ...
                string token = await _authService.LoginAsync(loginDTO.Username, loginDTO.Password);
